...
#define LUAT_CHECK_RESN(RES, TYPE, ID, N)           \
  ...
  {                                                 \
    ...
    {                                               \
      case LUA_TNUMBER:                             \
        printf("N");                                \
        *((lua_Number*)RES) = lua_tonumber(L, N);   \
        break;                                      \
                                                    \
      case LUA_TBOOLEAN:                            \
        printf("B");                                \
        *((int*)RES) = lua_toboolean(L, N);         \
        break;                                      \
                                                    \
      case LUA_TSTRING:                             \
        printf("S");                                \
        *((const char**)RES) = lua_tostring(L, N);  \
        break;                                      \
                                                    \
      case LUA_TLIGHTUSERDATA:                      \
        printf("L");                                \
        *((const void**)RES) = lua_topointer(L, N); \
        break;                                      \
                                                    \
      case LUA_TUSERDATA:                           \
        printf("U");                                \
      ...
      case LUA_TTHREAD:                             \
        ...
        break;                                      \
                                                    \
      default:                                      \
        luaL_error(L, "unknown argument type");     \
    }                                               \
  }


int luaT_checkargs1(lua_State *L,
                    void *r1, int type1, const void *id1)
{
  ...
  printf("\n--- now check1 ");
  LUAT_CHECK_RESN(r1, type1, id1, 1)
  printf("\n");

  return 1;
}

int luaT_checkargs2(lua_State *L,
                    void *r1, int type1, const void *id1,
                    void *r2, int type2, const void *id2)
{
  ...
  printf("\n--- now check2 ");
  LUAT_CHECK_RESN(r1, type1, id1, 1)
  LUAT_CHECK_RESN(r2, type2, id2, 2)
  printf("\n");

  return 1;
}

int luaT_checkargs3(lua_State *L,
                    void *r1, int type1, const void *id1,
                    void *r2, int type2, const void *id2,
                    void *r3, int type3, const void *id3)
{
  ...
  LUAT_CHECK_RESN(r1, type1, id1, 1)
  LUAT_CHECK_RESN(r2, type2, id2, 2)
  LUAT_CHECK_RESN(r3, type3, id3, 3)
  printf("\n");

  return 1;
}

int luaT_checkargs4(lua_State *L,
                    void *r1, int type1, const void *id1,
                    void *r2, int type2, const void *id2,
                    void *r3, int type3, const void *id3,
                    void *r4, int type4, const void *id4)
{
  ...
  LUAT_CHECK_RESN(r2, type2, id2, 2)
  LUAT_CHECK_RESN(r3, type3, id3, 3)
  LUAT_CHECK_RESN(r4, type4, id4, 4)
  printf("\n");

  return 1;
}

int luaT_checkargs5(lua_State *L,
                    void *r1, int type1, const void *id1,
                    void *r2, int type2, const void *id2,
                    void *r3, int type3, const void *id3,
                    void *r4, int type4, const void *id4,
                    void *r5, int type5, const void *id5)
{
  ...
  LUAT_CHECK_RESN(r3, type3, id3, 3)
  LUAT_CHECK_RESN(r4, type4, id4, 4)
  LUAT_CHECK_RESN(r5, type5, id5, 5)
  printf("\n");

  return 1;
}

int luaT_checkargs6(lua_State *L,
                    void *r1, int type1, const void *id1,
                    void *r2, int type2, const void *id2,
                    void *r3, int type3, const void *id3,
                    void *r4, int type4, const void *id4,
                    ...
                    void *r6, int type6, const void *id6)
{
  ...
  LUAT_CHECK_RESN(r4, type4, id4, 4)
  LUAT_CHECK_RESN(r5, type5, id5, 5)
  LUAT_CHECK_RESN(r6, type6, id6, 6)
  printf("\n");
