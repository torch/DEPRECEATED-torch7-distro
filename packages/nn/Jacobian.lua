...
function nn.Jacobian.testAllUpdate(module, input, weight, gradWeight)
   ...
   maccgp:backward(input, gradOutput)
   ...
   maccugp:backward(input, gradOutput)
   ...
   macsh1:backward(input, gradOutput)
   macsh2:backward(input, gradOutput)
   ...
   macshu1:backward(input, gradOutput)
   macshu2:backward(input, gradOutput)
